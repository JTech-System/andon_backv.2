...
export class GroupsController {
  ...
  async addUserToGroup(
    @Body() updateGroupDto: AddUserGroupDto,
  ): Promise<Group> {
    return await this.groupsService.addUserToGroup(updateGroupDto);
  }
  ...
  async removeUserFromGroup(
    ...
    return await this.groupsService.removeUserFromGroup(updateGroupDto);
  }
}
